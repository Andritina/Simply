...
import { Plus, Send } from "lucide-react";
        ...
        const MessageLeft = ({ text = "" }: { text: string }) => (
          <div className="flex items-start gap-3">
            <div className="w-8 h-8 rounded-full bg-[#333435] ring-1 ring-[#2b2b2b] flex items-center  text-sm">
              <img src="https://i.pravatar.cc/32" alt="a" className="w-5 h-8 rounded-full object-cover"/>
            </div>
        ...
        const MessageRight = ({ text = "" }: { text: string }) => (
          <div className="flex justify-end">
            <div className="relative">
              ...
              <div className="absolute -right-3 bottom-[-6px] w-9 h-9 rounded-full bg-[#0b6db0] ring-2 ring-[#141414] overflow-hidden flex items-center justify-center">
...
<div className="px-4 py-4 flex items-center gap-3 bg-[#161718] border-t border-[#262626]">
